...
3. Run the command `dotnet run` inside the directory that contains CentralGamesPlatform.csproj
4. The web app will be hosted on the localhost. The port may vary so be sure to see the output of the dotnet run command to see which port it is using
5. Paste the localhost and port number into a web browser of your choice. Example `https://localhost:50001`
